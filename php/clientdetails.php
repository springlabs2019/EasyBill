...
{ echo $message; } ?></div>
  ...
  <thead>
  <tr>
<th><input type="checkbox" id="checkAl">Select_All</th>
<th >Organtion Name</th>
<th>FirstName</th>
<th>LastName</th>
<th>Email</th>
<th>Web Url</th>
...
<?php
  ...
  /*Getting number of record iin databses */
     ...
     if($page>1)
     {
      echo "<a href='clientdetails.php?page=".($page-1)."' class='btn btn-primary'>Previous</a>";
     }

     for ($k=1; $k<$toatl_page;$k++)
     {
       echo "<a href='clientdetails.php?page=".$k."' class='btn btn-primary'>$k</a>";    
     }

     if($k>1)
     {
      echo "<a href='clientdetails.php?page=".($page+1)."' class='btn btn-primary'>Next</a>";
     }
?>
</div>
    </div>
