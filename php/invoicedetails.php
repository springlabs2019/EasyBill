...
<!--Delete option-->
    ...
    $del_id = $checkbox[$i]; 
    mysqli_query($conn, "DELETE FROM invoice WHERE invoiceno='".$del_id."'");
    $message = "Data deleted successfully !";
    }
    }
    
  $result = mysqli_query($conn, "SELECT * FROM invoice ORDER BY invoiceno DESC limit $start_from,$num_per_page");
  ?>
<div id="snackbar"><?php 
$message = "Data deleted successfully !"; 
{ echo $message; } ?></div>
