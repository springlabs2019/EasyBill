                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                               ...
                               <a href="..\html\vendors.html" class="btn btn-info btn-lg" style="background-color:#083551; font-size:15px;"><span class="glyphicon glyphicon-plus"></span>  New Vendor </a> 
                            </ul>
                        </div>
                    </div>
                </nav>                  
...
{ echo $message; } ?></div>
  ...
  <div class="col-lg-4">
            <div class="input-group">
                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Vendor." title="Type in a name" style="border-radius:5px; height:40px;">
...
<?php
  ...
  /*Getting number of record iin databses */
     $toatl_page =ceil($venumber/$num_per_page);
   /*  echo $toatl_page;*/
     ...
     if($page>1)
     {
      echo "<a href='vendordetails.php?page=".($page-1)."' class='btn btn-primary'>Previous</a>";
     }

     for ($k=1; $k<$toatl_page;$k++)
     {
       echo "<a href='vendordetails.php?page=".$k."' class='btn btn-primary'>$k</a>";    
     }

     if($k>1)
     {
      echo "<a href='vendordetails.php?page=".($page+1)."' class='btn btn-primary'>Next</a>";
     }
?>
</div>
  <br><br>
